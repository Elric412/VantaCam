...
const parseFrontmatter = (content) => ({ frontmatter: {} });
const readPatterns = (root) => ({ patterns: [], antipatterns: [] });
export { isSafeId, isSafeProvider, isSafeType, parseFrontmatter, readPatterns };
